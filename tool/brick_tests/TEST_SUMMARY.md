...
This document summarizes the comprehensive test suite added to validate all mason bricks in the Semaphore Client project.
...
The comprehensive test suite ensures that all mason bricks in the Semaphore Client project:
