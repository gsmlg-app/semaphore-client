  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AccessKeyRequest':
          return AccessKeyRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AccessKeyRequestLoginPassword':
          return AccessKeyRequestLoginPassword.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AccessKeyRequestSsh':
          return AccessKeyRequestSsh.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Environment':
          return Environment.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'EnvironmentRequest':
          return EnvironmentRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'EnvironmentSecret':
          return EnvironmentSecret.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'EnvironmentSecretRequest':
          return EnvironmentSecretRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Event':
        ...
        case 'InfoTypeUpdate':
          return InfoTypeUpdate.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Integration':
          return Integration.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'IntegrationExtractValue':
          return IntegrationExtractValue.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'IntegrationExtractValueRequest':
          return IntegrationExtractValueRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'IntegrationMatcher':
          return IntegrationMatcher.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'IntegrationMatcherRequest':
          return IntegrationMatcherRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'IntegrationRequest':
          return IntegrationRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Inventory':
          return Inventory.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'InventoryRequest':
          return InventoryRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Login':
          return Login.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LoginMetadata':
          return LoginMetadata.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LoginMetadataOidcProvidersInner':
          return LoginMetadataOidcProvidersInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Project':
          return Project.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackup':
          return ProjectBackup.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupEnvironmentsInner':
          return ProjectBackupEnvironmentsInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupInventoriesInner':
          return ProjectBackupInventoriesInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupKeysInner':
          return ProjectBackupKeysInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupMeta':
          return ProjectBackupMeta.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupRepositoriesInner':
          return ProjectBackupRepositoriesInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupTemplatesInner':
          return ProjectBackupTemplatesInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectBackupViewsInner':
          return ProjectBackupViewsInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdPutRequest':
          return ProjectProjectIdPutRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdPutRequestAllOf':
          return ProjectProjectIdPutRequestAllOf.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdRoleGet200Response':
          return ProjectProjectIdRoleGet200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdTasksPostRequest':
          return ProjectProjectIdTasksPostRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdTasksPostRequestParams':
          return ProjectProjectIdTasksPostRequestParams.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdUsersPostRequest':
          return ProjectProjectIdUsersPostRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectProjectIdUsersUserIdPutRequest':
          return ProjectProjectIdUsersUserIdPutRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectRequest':
          return ProjectRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProjectUser':
        ...
        case 'RepositoryRequest':
          return RepositoryRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Runner':
        ...
        case 'ScheduleRequest':
          return ScheduleRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Task':
        ...
        case 'TemplateSurveyVar':
          return TemplateSurveyVar.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TemplateSurveyVarValue':
          return TemplateSurveyVarValue.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TemplateVault':
          return TemplateVault.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'User':
          return User.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserPutRequest':
          return UserPutRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserRequest':
          return UserRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UsersUserIdPasswordPostRequest':
          return UsersUserIdPasswordPostRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'View':
