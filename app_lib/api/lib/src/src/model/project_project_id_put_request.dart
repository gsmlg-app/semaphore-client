...
class ProjectProjectIdPutRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProjectProjectIdPutRequest &&
     other.name == name &&
     other.alert == alert &&
  ...
  factory ProjectProjectIdPutRequest.fromJson(Map<String, dynamic> json) => _$ProjectProjectIdPutRequestFromJson(json);
