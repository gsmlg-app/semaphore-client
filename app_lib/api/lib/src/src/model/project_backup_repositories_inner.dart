...
class ProjectBackupRepositoriesInner {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProjectBackupRepositoriesInner &&
     other.name == name &&
     other.gitUrl == gitUrl &&
  ...
  factory ProjectBackupRepositoriesInner.fromJson(Map<String, dynamic> json) => _$ProjectBackupRepositoriesInnerFromJson(json);
