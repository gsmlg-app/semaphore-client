...
class ProjectProjectIdUsersPostRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProjectProjectIdUsersPostRequest &&
     other.userId == userId &&
     other.role == role;
  ...
  factory ProjectProjectIdUsersPostRequest.fromJson(Map<String, dynamic> json) => _$ProjectProjectIdUsersPostRequestFromJson(json);

  Map<String, dynamic> toJson() => _$ProjectProjectIdUsersPostRequestToJson(this);
