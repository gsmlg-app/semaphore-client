...
class IntegrationMatcher {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IntegrationMatcher &&
     other.id == id &&
  ...
  factory IntegrationMatcher.fromJson(Map<String, dynamic> json) => _$IntegrationMatcherFromJson(json);
