...
class EnvironmentRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentRequest &&
     other.id == id &&
     other.name == name &&
  ...
  factory EnvironmentRequest.fromJson(Map<String, dynamic> json) => _$EnvironmentRequestFromJson(json);
