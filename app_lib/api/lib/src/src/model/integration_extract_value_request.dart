...
class IntegrationExtractValueRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is IntegrationExtractValueRequest &&
          other.name == name &&
  ...
  factory IntegrationExtractValueRequest.fromJson(Map<String, dynamic> json) =>
      _$IntegrationExtractValueRequestFromJson(json);
