...
abstract class TemplateRequest implements Built<TemplateRequest, TemplateRequestBuilder> {
  ...
  TemplateRequestTypeEnum? get type;
...
class _$TemplateRequestSerializer implements PrimitiveSerializer<TemplateRequest> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.type != null) {
      ...
      yield serializers.serialize(
        object.type,
        specifiedType: const FullType(TemplateRequestTypeEnum),
      );
    }
...
class TemplateRequestTypeEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'')
  static const TemplateRequestTypeEnum empty = _$templateRequestTypeEnum_empty;
  @BuiltValueEnumConst(wireName: r'build')
  static const TemplateRequestTypeEnum build = _$templateRequestTypeEnum_build;
  @BuiltValueEnumConst(wireName: r'deploy')
  static const TemplateRequestTypeEnum deploy = _$templateRequestTypeEnum_deploy;

  static Serializer<TemplateRequestTypeEnum> get serializer => _$templateRequestTypeEnumSerializer;

  const TemplateRequestTypeEnum._(String name): super(name);

  static BuiltSet<TemplateRequestTypeEnum> get values => _$templateRequestTypeEnumValues;
  static TemplateRequestTypeEnum valueOf(String name) => _$templateRequestTypeEnumValueOf(name);
}
