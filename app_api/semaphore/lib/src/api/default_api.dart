...
import 'package:semaphore_api/src/model/info_type.dart';
...
class DefaultApi {
  ...
  Future<Response<BuiltList<JsonObject>>> appsGet({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Event>>> eventsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Event>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Event>>> eventsLastGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<InfoType>> infoGet({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InfoType),
      ) as InfoType;
