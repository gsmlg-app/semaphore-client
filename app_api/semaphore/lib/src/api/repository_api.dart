...
import 'package:semaphore_api/src/api_util.dart';
import 'package:semaphore_api/src/model/repository.dart';
import 'package:semaphore_api/src/model/repository_request.dart';
...
class RepositoryApi {
  ...
  const RepositoryApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<Repository>>> projectProjectIdRepositoriesGet({ 
    ...
    final _path = r'/project/{project_id}/repositories'.replaceAll('{' r'project_id' '}', encodeQueryParameter(_serializers, projectId, const FullType(int)).toString());
  ...
  Future<Response<Repository>> projectProjectIdRepositoriesPost({ 
    ...
    try {
      const _type = FullType(RepositoryRequest);
      _bodyData = _serializers.serialize(repository, specifiedType: _type);
  ...
  Future<Response<void>> projectProjectIdRepositoriesRepositoryIdDelete({ 
    ...
    final _path = r'/project/{project_id}/repositories/{repository_id}'.replaceAll('{' r'project_id' '}', encodeQueryParameter(_serializers, projectId, const FullType(int)).toString()).replaceAll('{' r'repository_id' '}', encodeQueryParameter(_serializers, repositoryId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
