...
import 'package:semaphore_api/src/model/login.dart';
import 'package:semaphore_api/src/model/login_metadata.dart';
...
class AuthenticationApi {
  ...
  Future<Response<LoginMetadata>> authLoginGet({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LoginMetadata),
      ) as LoginMetadata;
  ...
  Future<Response<void>> authOidcProviderIdLoginGet({ 
    ...
    final _path = r'/auth/oidc/{provider_id}/login'.replaceAll('{' r'provider_id' '}', encodeQueryParameter(_serializers, providerId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> authOidcProviderIdRedirectGet({ 
    ...
    final _path = r'/auth/oidc/{provider_id}/redirect'.replaceAll('{' r'provider_id' '}', encodeQueryParameter(_serializers, providerId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
